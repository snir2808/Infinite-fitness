...
const whatsApp = document.querySelector('.img_contact_logow');
whatsApp.addEventListener('click', () => {
    window.open('https://wa.me/+972539234339?text=היי אפשר לשמוע פרטים נוספים?')
});

const faceBook = document.querySelector('.img_contact_logof');
faceBook.addEventListener('click', () => {
    window.open('https://www.facebook.com/Infinity-Fitness-%D7%A1%D7%98%D7%95%D7%93%D7%99%D7%95-%D7%9C%D7%90%D7%99%D7%9E%D7%95%D7%A0%D7%99%D7%9D-%D7%90%D7%99%D7%A9%D7%99%D7%99%D7%9D-2189267681318332/');
});

const instagram = document.querySelector('.img_contact_logoi');
instagram.addEventListener('click',() => {
    window.open('https://www.instagram.com/infinity____fitness/');
});

const waze = document.querySelector('.img_contactwaze');
waze.addEventListener('click', () => {
    window.open('https://waze.com/ul/hsv89xgrp2');
});

const call = document.querySelector('.img_contact_call');
call.addEventListener('click', () => {
    window.open('tel:+972539234339');
})
